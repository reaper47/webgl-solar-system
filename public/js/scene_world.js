...
let guiSurface = gui.addFolder('Surface')
let guiMarkers = guiSurface.addFolder('Markers')
let guiAtmosphere = gui.addFolder('Atmosphere')
let guiAtmosphericGlow = guiAtmosphere.addFolder('Glow')
...
let surfaceControls = new function () {
  this.rotation = 0
  this.bumpScale = 0.05
  this.shininess = 10
}()

let markersControls = new function () {
  this.address = ''
  this.color = 0xff0000
...
let atmosphereControls = new function () {
  this.opacity = 0.8
}()

let atmosphericGlowControls = new function () {
  this.intensity = 0.7
  this.fade = 7
  this.color = 0x93cfef
}()
